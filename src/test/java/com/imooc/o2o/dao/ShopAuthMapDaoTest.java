...
public class ShopAuthMapDaoTest {
    ...
    public void testBQueryShopAuth() throws Exception {
        ...
        List<ShopAuthMap> shopAuthMapList = shopAuthMapDao.queryShopAuthMapListByShopId(13, 0, 2);
        ...
        int count = shopAuthMapDao.queryShopAuthCountByShopId(13);
    ...
    public void testCUpdateShopAuthMap() throws Exception {
        List<ShopAuthMap> shopAuthMapList = shopAuthMapDao.queryShopAuthMapListByShopId(13, 0, 1);
    ...
    public void testDeleteShopAuthMap() throws Exception {
        List<ShopAuthMap> shopAuthMapList1 = shopAuthMapDao.queryShopAuthMapListByShopId(13, 0, 1);
        List<ShopAuthMap> shopAuthMapList2 = shopAuthMapDao.queryShopAuthMapListByShopId(14, 0, 1);
